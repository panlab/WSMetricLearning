function [W, Xi, Diagnostics] = mlr_train_latent_f_t(X, Y, numSign, ...
...
%             th = tic;
            [PsiNew, Mnew, SO_time, hLatent, RLatent]     = CP(k, X, hLatent, RLatent, PsiLatent, ...
                numSign, W, Ypos, Yneg, batchSize, Template, Nrotate, SAMPLES, ClassScores);
%             th = toc(th);
%             fprintf('Time for CP: %d\n', th);
