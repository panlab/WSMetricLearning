function [database, lenStat] = CalculateSiftDescriptor_O(rt_img_dir, ...
    ort_data_dir, gridSpacing, patchSize, maxImSize, nrml_threshold, ...
    copyremove, tfeattype, setting)
%==========================================================================
...
feattype{1} = tfeattype;
rt_data_dir{1} = ort_data_dir;
