...
for iind = [1]
    for jind = length(cstr{iind}):-1:1
        str = cstr{iind}{jind};
        ind = 2;TrainFun = @GetRecogRate_3;
        Voting = 7;cd(fullfile(PATH_F, 'demo\WSMTL'));VirTest = 0;newd = '_PIE';MLRvir1;
    end
end
clear all;
GetGlobalSetting;cd(fullfile(PATH_F, 'demo\WSMTL'));str = '_PIE';TrainFun = @GetRecogRate_3;TBest = 1;VirTest = 0;Ninit = 31;newd = -1;isdegree = 1;featnorm = 1;indindex = 1;Numtrain = 30;Srange = [1];iirange = [1, 2, 3, 5, 8];WSMLR_N
...
clear all;GetGlobalSetting;cd(fullfile(PATH_F, 'demo\WSMTL'));str = '_PIE';TrainFun = @GetRecogRate_3;TBest = 1;VirTest = 0;Ninit = 31;newd = -1;isdegree = 0;featnorm = 1;indindex = 1;Numtrain = 30;Srange = 1;iirange = [1, 2, 3, 5, 8];WSMLR_N
% % 
...
% % str = cstr{iind}{jind};
% % ind = 2;TrainFun = @GetRecogRate_3;
% % Voting = 7;cd(fullfile(PATH_F, 'demo/WSMTL'));VirTest = 0;newd = '_PIE';MLRvir;
% % end
% % end
% % try
...
% % end
% % clear all;GetGlobalSetting;cd(fullfile(PATH_F, 'demo/WSMTL'));str = '_PIE';TrainFun = @GetRecogRate_3;
% % TBest = 0;VirTest = 0;Ninit = 31;newd = -1;isdegree = 0;RR = [0.2:0.2:1];featnorm = 1;indindex = 1;Srange = 1;Numtrain = 30;iirange = [1, 2, 3, 5, 8];WSMLR_N
