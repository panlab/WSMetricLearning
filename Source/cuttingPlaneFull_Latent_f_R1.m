function [dPsi, M, SO_time, hLatent, RLatent, PsiLatentS, TSAMPLES, penalty1] = ...
    cuttingPlaneFull_Latent_f_R1(k, KNNlatent, X, hLatent, RLatent, ...
...
%             yik = zeros(nbase, length(Range));
            ...
            for j = TSAMPLES
                ...
                [Dneg,ord] = sort(D, 'descend');
%                 ord = ord(2:KNNlatent+1);
%                 Dneg = Dneg(1:KNNlatent+1);%%%the first one is positive
