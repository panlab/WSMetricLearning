function [W, Xi, Diagnostics, Wtmp] = mlr_train_latent_f4(W, X, Y, numSign, ...
...
%         Diagnostics.f
        ...
        if num_calls_latent > 0
            ...
            if (abs(f_old - Diagnostics.f(end) / f_old) < 0.01)
    ...
    Diagnostics.ObjFun = ObjFun;Diagnostics.ObjCons = ObjCons;
end
