function [W, Xi, Diagnostics, yrank, X, XDic] = mlr_train1(W, SampleW, X, Y, Cslack, varargin)
...
%         end
        ...
        PsiClock                        = PsiClock + 1;
        Solver_time                     = tic();
        [X, obj, XDic]                  = mlr_Temp1(Diagnostics.num_calls_solver, NN, Nneg, Npos, Margins, KmeanA, KmeanLAMDA, MeanK, X, ...
            XX, XDic, Ypos, SampleW, TemplateUp, Ymatched, W, SAMPLES, ...
            FeatUp, TemplateNorm, UpSolver, innc, cpara, innerfea, cparaINNC, ITERkmean);
        if W_update
