function Clustering(dataname, suffix, Nclass, method, C, knnpara, multiview,...
    NFold, Round, evaltype, Kinit)
...
if nargin < 11 Kinit = 50;end  

Nclass = str2num(Nclass);C = str2num(C);knnpara = str2num(knnpara);multiview = str2num(multiview);
NFold = str2num(NFold); Round = str2num(Round);evaltype= str2num(evaltype);Kinit= str2num(Kinit);
...
[cmethod, cpara, KNNround, SnippetRatio, C, setting] = getMConfig(method, C,dataname,NFold, Round);
