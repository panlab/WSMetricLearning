...
if SelectMethod < 5
    ...
    switch SelectMethod
        ...
        case 7
            ...
            C = [C1, C2, conf_tr_fea];
            RINDEX = [RINDEX1, RINDEX2, 2, size(conf_tr_fea, 2)-2];
            return;
        case 8
        ...
        case 9
            ...
            C = [C1, C2, conf_tr_fea, tr_fea];
            RINDEX = [RINDEX1, RINDEX2, 2, size(conf_tr_fea, 2)-2, size(tr_fea, 2)];
            return;
        ...
        case 51 %%test rank  
            ...
            C = [C1, C2, conf_tr_fea, Yrank];
            RINDEX = [RINDEX1, RINDEX2, 2, size(conf_tr_fea, 2)-2, size(Yrank, 2)];
            return;
...
if Smothod == 1
    ...
    if SDIVmothod
        RINDEX = [size(distance(:, 1), 2), size(C, 2)];
