...
sstr = [database, sstr];
try
    load(['D:/machine learning/Code/wsmlr_code/TrainInfo/image_' sstr '_1_Floderinfo.mat'])
catch
    load(['D:/machine learning/Code/wsmlr_code/TrainInfo/image_' sstr '_0_Floderinfo.mat'])
end
