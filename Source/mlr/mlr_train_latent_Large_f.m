function [W, Xi, Diagnostics, Wtmp] = mlr_train_latent_Large_f(W, X, Y, datastr, numSign,CIndex, ...
      Tlatentinfo, latentfile, rotate, rawsize, KNNlatent, ts_imname, tr_imname, Asubname, Cslack, varargin)
%
